...
export function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userResponse = await userAPI.findByEmail(formData.email);
      ...
      // Verify password against stored hash securely
      const isValidPassword = bcrypt.compareSync(formData.password, user.password_hash);
