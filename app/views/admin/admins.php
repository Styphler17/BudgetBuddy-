<div class="space-y-8">
    <header class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <a href="<?php echo BASE_URL; ?>/admin/admins/create" class="inline-flex h-10 items-center justify-center rounded-md bg-primary px-4 text-sm font-medium text-white hover:bg-primary/90 transition-colors">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo BASE_URL; ?>/admin/admins/edit/<?php echo $a['id']; ?>" class="p-2 text-gray-400 hover:text-primary transition-colors" title="Edit">
