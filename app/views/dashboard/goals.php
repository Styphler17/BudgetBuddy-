<div class="p-4 sm:p-6 space-y-6">
    ...
    <div id="add-goal-form" class="hidden bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        ...
        <form action="/BudgetBuddy-/goals/create" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="space-y-1">
            ...
            <div class="bg-white p-6 rounded-xl border <?php echo $isCompleted ? 'border-green-200 bg-green-50/30' : 'border-gray-200'; ?> shadow-sm space-y-4 group relative">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition-all">
                        ...
                        <a href="/BudgetBuddy-/goals/delete/<?php echo $goal['id']; ?>" class="p-1 text-gray-400 hover:text-red-500 transition-colors" onclick="return confirm('Delete this goal?')"><i data-lucide="trash-2" class="h-4 w-4"></i></a>
                    </div>
                </div>
