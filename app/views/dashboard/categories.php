<div class="p-4 sm:p-6 space-y-6">
    ...
    <div id="add-cat-form" class="hidden bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <?php else: ?>
            ...
            ?>
            <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border <?php echo $isOverBudget ? 'border-red-200 dark:border-red-900/50 bg-red-50/30 dark:bg-red-900/10' : 'border-gray-200 dark:border-white/10'; ?> shadow-sm space-y-4 group relative">
