...
<div class="space-y-6">
    ...
    <div id="add-tx-form" class="hidden bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        ...
        <form action="/BudgetBuddy-/transactions/create" method="POST" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="space-y-1">
            ...
            <?php else: ?>
                ...
                <div class="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="/BudgetBuddy-/transactions/delete/<?php echo $tx['id']; ?>" class="p-2 text-gray-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-all" onclick="return confirm('Delete this transaction?')">
