    ...
    <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
        <form method="GET" action="<?php echo BASE_URL; ?>/transactions" class="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo BASE_URL; ?>/transactions" class="h-9 w-9 flex items-center justify-center bg-gray-100 text-gray-500 dark:text-slate-300 rounded-md hover:bg-gray-200" title="Reset Filters">
