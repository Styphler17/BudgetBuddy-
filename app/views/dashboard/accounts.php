<div class="p-4 sm:p-6 space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white font-outfit">Accounts</h1>
        ...
        <div class="flex flex-col sm:flex-row gap-2">
            <button onclick="document.getElementById('transfer-modal').classList.toggle('hidden')" class="inline-flex h-10 items-center justify-center rounded-md border border-gray-300 dark:border-white/10 bg-white dark:bg-slate-900 px-4 text-sm font-medium text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors w-full sm:w-auto">
    ...
    <div id="transfer-modal" class="hidden glowing-wrapper animate-fade-in">
        ...
        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm relative z-10">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-bold text-gray-900 dark:text-white font-outfit">Transfer Between Accounts</h3>
            ...
            <form action="<?php echo BASE_URL; ?>/accounts/transfer" method="POST" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="space-y-1">
                    ...
                    <select id="from_account_id" name="from_account_id" class="w-full h-10 border border-gray-300 dark:border-white/10 rounded-md px-3 text-sm outline-none bg-white dark:bg-slate-900 dark:text-white" required>
                ...
                <div class="space-y-1">
                    ...
                    <select id="to_account_id" name="to_account_id" class="w-full h-10 border border-gray-300 dark:border-white/10 rounded-md px-3 text-sm outline-none bg-white dark:bg-slate-900 dark:text-white" required>
                        <?php foreach ($accounts as $acc): ?>
                ...
                <div class="space-y-1">
                    ...
                    <input id="transfer_amount" type="number" name="amount" step="0.01" class="w-full h-10 border border-gray-300 dark:border-white/10 rounded-md px-3 text-sm outline-none focus:ring-2 focus:ring-primary/20 bg-white dark:bg-slate-900 dark:text-white" required>
                </div>
                ...
                <div class="md:col-span-4">
                    <input id="transfer_description" type="text" name="description" placeholder="Optional notes..." class="w-full h-10 border border-gray-300 dark:border-white/10 rounded-md px-3 text-sm outline-none bg-white dark:bg-slate-900 dark:text-white">
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="add-account-form" class="hidden glowing-wrapper">
        <div class="glowing-effect-container"></div>
        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm relative z-10">
            ...
            <form action="<?php echo BASE_URL; ?>/accounts/create" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="space-y-1">
                    ...
                    <input id="account_name" type="text" name="name" placeholder="e.g. Main Checking" class="w-full h-10 border border-gray-300 dark:border-white/10 rounded-md px-3 text-sm focus:ring-2 focus:ring-primary/20 outline-none bg-white dark:bg-slate-900 dark:text-white" required>
                </div>
                <div class="space-y-1">
                    <label for="account_type" class="text-xs font-bold text-gray-500 dark:text-slate-400 uppercase">Type</label>
                    <select id="account_type" name="type" class="w-full h-10 border border-gray-300 dark:border-white/10 rounded-md px-3 text-sm focus:ring-2 focus:ring-primary/20 outline-none bg-white dark:bg-slate-900 dark:text-white">
                ...
                <div class="space-y-1">
                    ...
                    <input id="account_balance" type="number" name="balance" step="0.01" class="w-full h-10 border border-gray-300 dark:border-white/10 rounded-md px-3 text-sm focus:ring-2 focus:ring-primary/20 outline-none bg-white dark:bg-slate-900 dark:text-white" required>
                </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <?php else: ?>
            ...
            <div class="glowing-wrapper">
                <div class="glowing-effect-container"></div>
                <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-white/10 shadow-sm space-y-4 group relative z-10 h-full">
