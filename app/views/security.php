<div class="min-h-screen bg-white">
    ...
    <section class="bg-gray-50 py-16 pt-32">
        <div class="container mx-auto max-w-4xl px-6 text-center">
            ...
            <span class="inline-block px-3 py-1 rounded-full bg-green-100 text-green-700 text-xs font-bold uppercase tracking-widest">
        ...
        <div class="max-w-4xl mx-auto space-y-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4 font-outfit">Data Encryption</h3>
                ...
                <div class="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4 font-outfit">Authentication</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4 font-outfit">Privacy First</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4 font-outfit">Regular Audits</h3>
                    <p class="text-gray-600 leading-relaxed">
    ...
    <section class="py-20 bg-gray-900 text-white">
        <div class="container mx-auto px-6 text-center">
            <div class="max-w-2xl mx-auto">
                ...
                <a href="/BudgetBuddy-/contact" class="inline-flex items-center justify-center px-8 py-3 bg-white text-gray-900 font-bold rounded-md hover:bg-gray-100 transition-colors">
