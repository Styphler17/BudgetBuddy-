<footer class="bg-gray-900 text-gray-300 py-20 border-t border-gray-800">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
            ...
            <div class="lg:col-span-4 space-y-6">
                <a href="/" class="flex items-center space-x-3 group">
                    <img src="/public/BudgetBuddy.png" alt="BudgetBuddy" class="h-12 w-12 rounded-xl object-cover shadow-lg group-hover:rotate-6 transition-transform">
                    <span class="text-2xl font-bold text-white font-outfit">BudgetBuddy</span>
                </a>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li><a href="/register" class="hover:text-white transition-colors">Start Free</a></li>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-gray-500">
            <p>© <?php echo date('Y'); ?> BudgetBuddy. All rights reserved.</p>
